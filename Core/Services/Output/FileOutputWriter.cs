...
public class FileOutputWriter : IOutputWriter
{
    ...
    /// <summary>
    /// Writes the host-level <c>llms_full.txt</c> file with detailed metadata for each page, used for debugging and analysis.
    /// </summary>
    ...
    public async Task WriteLlmsFullTxtAsync(Uri rootUrl,IReadOnlyList<SummaryResult> pages, CancellationToken ct = default)
{
    ...
    sb.AppendLine($"Pages included: {pages.Count}");
    sb.AppendLine();
